...
private:
    ...
    initializer_list<T_> getSubstringData() const {
        auto begin = m_data.cbegin() + m_pos;
        auto end = begin + m_count;
        return initializer_list<T_>(begin, end);
    }
